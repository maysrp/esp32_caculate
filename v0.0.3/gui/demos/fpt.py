...
from spi2 import ssd  # Create a display instance
...
def cart():
    ...
    g = CartesianGraph(wri, 2, 2, width=300,height=200,yorigin = 2, fgcolor=WHITE, gridcolor=LIGHTGREEN) # Asymmetric y axis
    curve1 = Curve(g, YELLOW, populate_1(lambda x : 0.87651*x+ 1/2,)) # args demo
...
def lem():
    ...
    g = CartesianGraph(wri, 2, 2, width=300,height=200, fgcolor=WHITE, gridcolor=LIGHTGREEN)
...
def seq():
    ...
    g = CartesianGraph(wri, 2, 2, xorigin = 10, fgcolor=WHITE,width=300,height=200,
